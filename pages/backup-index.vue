<template>
        ...
        <v-row>
            <v-col cols="12" md="4">
                <v-sheet class="pa-4" elevation="2">
                    ...
                    <p>Jumlah pengguna terdaftar: 1000</p>
                </v-sheet>
            </v-col>
            <v-col cols="12" md="4">
                <v-sheet class="pa-4" elevation="2">
                    <h3>Penjualan Hari Ini</h3>
                    <p>Total penjualan: $500</p>
                </v-sheet>
            </v-col>
            <v-col cols="12" md="4">
                <v-sheet class="pa-4" elevation="2">
                    <h3>Pengunjung Situs</h3>
                    <p>Jumlah pengunjung: 2000</p>
                </v-sheet>
            </v-col>
        </v-row>
    </v-container> -->
    ...
    <v-container>
        <v-img
            ...
            alt="Iklan Metro Bali" class="article-image mx-5 my-5" @click="handleImageAdClick" />
        ...
        <v-row class="mx-5 my-5" align="center">
            <v-col cols="1" order="1">
                <span class="text-h6">Trending</span>
            </v-col>
            <v-col cols="11" order="2">
        ...
        <CustomCard class="mx-5 my-5">
            <!-- headlines -->
            <!-- Tabs untuk Headline dan Video -->
            <v-tabs v-model="tab" class="mb-3">
                <v-tab value="headline"><v-icon size="30" class="mr-2">mdi-newspaper-variant-outline</v-icon>
                    Headline</v-tab>
                <v-tab value="video"> <v-icon size="30" class="mr-2">mdi-video-outline</v-icon> Live Update</v-tab>
            </v-tabs>
